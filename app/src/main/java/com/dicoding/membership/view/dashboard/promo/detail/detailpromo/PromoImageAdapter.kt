...
class PromoImageAdapter(private val context: Context) :
    RecyclerView.Adapter<PromoImageAdapter.ViewHolder>() {
    ...
    inner class ViewHolder(private val binding: ItemMultipleImageUpload2Binding) :
        ...
        fun bind(imageUrl: String) {
            try {
                ...
                Log.e("PromoImageAdapter", "Error loading image: ${e.message}")
