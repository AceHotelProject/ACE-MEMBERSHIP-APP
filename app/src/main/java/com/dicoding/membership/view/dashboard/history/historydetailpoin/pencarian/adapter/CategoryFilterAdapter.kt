...
class CategoryFilterAdapter(
    ...
    private val onItemSelected: (CategoryFilter) -> Unit
    ...
    class ViewHolder(private val binding: ItemFilterChipBinding) :
        ...
        fun bind(filter: CategoryFilter, isSelected: Boolean) {
            binding.itemFilterChip.apply {
                text = when (filter) {
                    CategoryFilter.TRANSFER -> "Transfer"
                    CategoryFilter.RECEIVE -> "Terima"
                }
